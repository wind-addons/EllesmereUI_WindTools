...
local L = EllesmereUI.RegisterLocale("enUS")
...
L["Interface"] = true
L["Items & Combat"] = true
L["Mark this option page as migration-ready"] = true
L["Migration shell for WindTools on EllesmereUI."] = true
L["Modules"] = true
L["Off"] = true
L["On"] = true
L["Option Categories"] = true
L["Shell"] = true
L["Show disconnected module placeholders"] = true
L["Status"] = true
L["These controls store migration preferences only; they do not load feature code yet."] = true
L["This addon is registered through EllesmereUI. The original ElvUI-backed WindTools modules remain disconnected so they do not load against missing ElvUI APIs."] = true
L["This is a stored preference only until the module is migrated."] = true
L["WindTools Migration Shell"] = true
L["World & Quest"] = true
L["Bookkeeping flag for the migration pass. It does not enable gameplay behavior."] = true
L["Controls whether this page lists modules that are not wired yet."] = true
L["Current scope: option-page shell, profile storage, and migration metadata. No gameplay feature module is active yet."] = true
L["Item, merchant, mail, inspect, and equipment quality-of-life options."] = true
L["Combat feedback, markers, keystone helpers, and meter layout options."] = true
L["World map, minimap, tracker, and event display options."] = true
L["Quest tracker, achievement tracker, objective progress, and turn-in options."] = true
L["Chat, links, emotes, friends, and context menu options."] = true
L["Automatic group, quest, keystone, and utility announcement options."] = true
L["Tooltip information, Mythic Plus, progression, and item-set options."] = true
L["Unit frame tags, absorb, role icon, focus, and name clipping options."] = true
L["Blizzard, widget, library, ElvUI, and third-party addon skin options."] = true
L["General quality-of-life, automation, LFG, frame movement, and utility options."] = true
L["Migration, compatibility, profile, and developer-oriented settings."] = true
L["Credits, links, help, and migration notes."] = true
