...
W.Changelog[100] = {
	...
	NEW = {
		["zhCN"] = {
			"新增独立的 EllesmereUI 风格选项面板，支持侧边栏导航、搜索、子页面和模块启用开关。",
			"完成额外物品条迁移：支持 5 个可自定义物品条、按键绑定、空栏自动隐藏、装备图标同步，以及预览和固定物品条选择器。",
		...
		["zhTW"] = {
			...
			"完成額外物品條遷移：支援 5 個可自訂物品條、按鍵綁定、空欄自動隱藏、裝備圖示同步，以及預覽和固定物品條選擇器。",
		...
		["enUS"] = {
			...
			"Ported Extra Item Bar with 5 customizable bars, keybinds, auto-hide when empty, equipment icon syncing, and bar preview/pinning controls.",
		...
		["koKR"] = {
			...
			"5개의 사용자 지정 바, 키 바인딩, 빈 바 자동 숨김, 장비 아이콘 동기화 및 미리보기/고정 기능을 지원하는 Extra Item Bar를 포팅했습니다.",
		...
		["ruRU"] = {
			...
			"Перенесён Extra Item Bar: 5 настраиваемых панелей, бинды, автоскрытие пустых панелей, синхронизация значков экипировки и управление предпросмотром/закреплением.",
	...
	IMPROVEMENT = {
		["zhCN"] = {
			"选项页面统一使用 EllesmereUI 原生控件，并对未迁移功能提供明确的禁用状态。",
		},
		["zhTW"] = {
			"選項頁面統一使用 EllesmereUI 原生控制項，並對未遷移功能提供明確的停用狀態。",
		},
		["enUS"] = {
			"Option pages now use native EllesmereUI widgets, with clear disabled states for features that have not been ported yet.",
		},
		["koKR"] = {
			"옵션 페이지가 EllesmereUI 기본 위젯을 사용하며 아직 포팅되지 않은 기능은 명확하게 비활성화됩니다.",
		},
		["ruRU"] = {
			"Страницы настроек используют нативные виджеты EllesmereUI; ещё не перенесённые функции имеют явное отключённое состояние.",
		},
	},
}
