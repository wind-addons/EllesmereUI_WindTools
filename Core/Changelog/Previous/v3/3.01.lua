...
W.Changelog[301] = {
	...
	IMPORTANT = {
		["zhCN"] = {
			...
			"[配置文件] 你可以通过降级 ElvUI 和 EllesmereUI_WindTools 来继续使用旧的导出字符串, 然后再升级到最新版本.",
		},
		["zhTW"] = {
			...
			"[設定檔] 你可以通過降級 ElvUI 和 EllesmereUI_WindTools 來繼續使用舊的導出字串, 然後再升級到最新版本.",
		},
		["enUS"] = {
			...
			"[Profile] You can downgrade ElvUI and EllesmereUI_WindTools to continue using the old export string, then upgrade to the latest version.",
		},
		["koKR"] = {
			...
			"[프로필] 이전 내보내기 문자열을 계속 사용하려면 ElvUI 및 EllesmereUI_WindTools를 다운그레이드 한 다음 최신 버전으로 업그레이드 할 수 있습니다.",
		},
	},
	NEW = {
		["zhCN"] = {},
